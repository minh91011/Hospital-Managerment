...
<html>
    ...
    if(u==null){
        ...
        <%
         ...
         if(x==null) return;
        %>    
        <h2>Update new nurse</h2>
        <div class="formInsert">
            <form action="updateNurse" method="POST">
                <ul>
                    <li><p>Id<input type="text" name="nu_id" value="<%=x.getNu_id()%>" readonly> </p></li>
                    ...
                    <li><p><input type="submit" value="updateNurse"></p></li>
                </ul>
            </form>
        </div>
