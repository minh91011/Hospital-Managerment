    ...
    <body>
        ...
        <div class="formInsert">
            <form action="insertPatient" method="POST">
                <ul>
                    <li><p>Id<input type="text" name="pa_id" value=""> </p></li>
                    ...
                    <li><p>Doc_id<input type="text" name="doc_id" value=""> </p></li>
                    <li><p class="okay"><input type="submit" value="insertPatient"></p></li>
                </ul>
