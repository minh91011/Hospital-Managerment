...
<html>
    ...
    <body>
        ...
        <h2>Insert new nurse</h2>
        <div class="formInsert">
            <form action="insertNurse" method="POST">
                <ul>
                    <li><p>Id<input type="text" name="nu_id" value=""> </p></li>
                    <li><p>FullName<input type="text" name="fullname" value=""> </p></li>
                    ...
                    <li><p>Address<input type="text" name="address" value=""> </p></li>
                    <li><p class="okay"><input type="submit" value="insertNurse"></p></li>
                </ul>
