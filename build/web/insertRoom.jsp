    ...
    <body>
        ...
        <div class="formInsert">
            <form action="insertRoom" method="POST">
                <ul>
                    <li><p>Id<input type="text" name="room_id" value=""> </p></li>
                    <li><p>Available<input type="text" name="available" value=""> </p></li>
                    <li><p>PricePerDay<input type="text" name="priceperday" value=""> </p></li>
                    <li><p>Type 
                    ...
                    <li><p class="okay"><input type="submit" value="insertRoom"></p></li>
                </ul>
